 	...
 	<script type="text/javascript">
		...
		{		            			
		    ...
		    //******************************************************
					...
					formData.append("id_generado_por", -1);
				...
				if (check.checked)
		    {
					...
					{
						alert("Error. Verifique que el gasto no este registrado. Si el error persiste consulte con el administrador");
					}
		...
		var listar = function()
		{
					...
					table = $('#tabla_gastos').DataTable({
						...
						"ajax":{
							"method":"POST",
							"url":"<?php echo base_url(); ?>index.php/validacion/consulta_gastos_validar_cobrador",
						},
				...
				<div class="myform-bottom">
                   	<table width="100%"> 	
						...
						<tr style="display: none;">
							<td>Realizado por: </td> 
							<td>
								<select style="height: 30px;width: 100%;" name="cobrador" id="cobrador">
									<?php 
						...
						<tr >
							<td style="display: none;">Es Gasto Común? </td>
							<td  style="display: none;"><input readonly="true" type="checkbox" id="check_gasto_comun" onclick="calcular()" value="check" checked> Sí </td>
						</tr>
					</table>
					
					<table style="width: 100%">
						<tr style="height: 10px"></tr>
							<td><input type="submit" class="btn-sm" style="background-color: #C8216A;color: #FFFFFF;width: 95%" value="Guardar" onclick="registrar_gasto()"/></td>
							<form action="<?= base_url() .'index.php/menu_principal/menu_reporte_cobradores'?>" method="post" class="">		
					...
					<div class="table-responsive">    
		                ...
		                <table id="tabla_gastos" width="100%" style="font-family:sans-serif; font-size: 12px;">
								<colgroup>
									<col style="width: 10%;">
				       				<col style="width: 30%;">
				       				<col style="width: 30%;">
