...
<head>
    ...
    <script>
        $(document).ready(function(e) {
            ...
            {
                $('#principal').load('<?php echo base_url(); ?>index.php/menu_principal/aprobar_solicitudes',function(data)
                {
                    $(this).html(data);
                });
            });

            $('#solicitudes_tramitadas').click(function(event)
            {
                $('#principal').load('<?php echo base_url(); ?>index.php/menu_principal/historial_solicitudes_tramitadas',function(data)
                {
                    $(this).html(data);
                });
            });
            ...
            {
                $('#principal').load('<?php echo base_url(); ?>index.php/menu_principal/reportes',function(data)
                {
                    $(this).html(data);
                });
            });
        ...
        <div class="row">
            <div class="col-md-3 myform-cont" >
                ...
                <div class="myform-bottom-principal">
                        ...
                        <button id="aprobacion" type="submit" class="option"><img src="<?php echo base_url(); ?>images/tramitar.png" align="left"/>Aprobación de Solicitudes</button>
                   
                        <button id="solicitudes_tramitadas" type="submit" class="option"><img src="<?php echo base_url(); ?>images/historial.png" align="left"/>Historial de Solicitudes Tramitadas</button>

                        <button id="reportes" type="submit" class="option"><img src="<?php echo base_url(); ?>images/historial.png" align="left"/>Reportes</button>
