		...
		<div class="row">
			<div class="col-md-6 offset-md-3 myform-cont" >				
				<div class="myform-top">
					<strong align="left">Abonos Créditos Vigentes</strong>
				</div>
				<div class="myform-bottom table-responsive">    
				<table style="width: 100%">
       				<tr>
                		<form action="<?= base_url() .'index.php/validacion/mostrar_abonos'?>" method="post" class="">
	                		...
	                		<td><input type="text" style="display: none;" name="id_detalle_credito" id="id_detalle_credito"></td>        		
	                   	</form>
                    ...
                    <table id="tabla_cobros" width="100%" style=" text-align: center;font-family:sans-serif; font-size: 13px;">
						<colgroup>
		       				<col style="width: 10%;">
		       				<col style="width: 30%;">
		       				<col style="width: 20%;">
