 	...
 	<script type="text/javascript">
		...
		var listar_credito = function()
		{
					...
					table = $('#tabla_credito').DataTable({
						...
						"ajax":{
							"method":"POST",							
							"url":"<?php echo base_url(); ?>index.php/validacion/consulta_cuadre_caja_anterior",
							"data" : {"id_cuadre_caja": $("#id_cuadre_caja").val(),
									  "tipo": "NC",
									  "campo_tabla": "cc.t_credito" 	
								 }
						},
						...
						"columns":[							
							...
							{"render":
								function ( data, type, row ) {
									$("#t_credito").val(row["t_credito"]);
									$("#t_liquidacion").val(row["t_cuadre_caja"]);
							  		return ("$ " + row["valor"]);	        						
							  	}
							}					  											
						],				
			...
			<div class="col-md-6 offset-md-3 myform-cont" >				
				...
				<div class="myform-bottom">
                   	<table style="width: 100%">
	                   	<tr>	 	 	
						 	<td>Fecha Inicio</td>
						 	<td><input type="text" name="fecha_i"  id="fecha_i" value="<?php echo $fecha_inicio?>" style="height: 20px;width: 100%;font-size: 13px;">	 		
						 	</td>	
						 	<td><input type="text" name="id_cuadre_caja"  id="id_cuadre_caja" value="<?php echo $id_cuadre_caja?>" style="height: 20px;width: 100%;font-size: 13px;display: none;">	 		
						 	</td> 	
						</tr>
						<tr>
							<td>Fecha Fin</td>
							<td><input type="text" name="fecha_f" id="fecha_f" value="<?php echo $fecha_fin?>" style="height: 20px;width: 100%;font-size: 13px;">	 		
						 	</td>
						 	
		 				</tr>
		 				<tr>
							<td>Cobrador</td>
							<td><input readonly="true" type="text" name="cobrador" id="cobrador" value="<?php echo $cobrador?>" style="height: 20px;width: 100%;font-size: 13px;">	 		
						 	</td>
					...
					<div class="table-responsive" >    
		                ...
		                <table id="tabla_caja" width="100%" style="font-family:sans-serif; font-size: 12px;text-align: center">
								<colgroup>
									<col style="width: 10%;">
									<col style="width: 30%;">
				       				<col style="width: 30%;">
	                ...
	                <div class="table-responsive">    
		                ...
		                <table id="tabla_abono" width="100%" style="font-family:sans-serif; font-size: 12px;text-align: center">
								<colgroup>
									<col style="width: 10%;">
				       				<col style="width: 30%;">
				       				<col style="width: 30%;">
		            ...
		            <table id="tabla_credito" width="100%" style="font-family:sans-serif; font-size: 12px;text-align: center">
								<colgroup>
									<col style="width: 10%;">
				       				<col style="width: 30%;">
				       				<col style="width: 30%;">
					...
					<table style="width: 100%; color:#FFFFFF; background-color: #C8216A;">	
		                ...
		                <table id="tabla_gastos" width="100%" style="font-family:sans-serif; font-size: 12px;text-align: center">
								<colgroup>
									<col style="width: 10%;">
				       				<col style="width: 30%;">
				       				<col style="width: 30%;">
	                ...
	                <table style="width: 100%"">
	                	<tr>
	                 		<form action="<?= base_url() .'index.php/menu_principal/consultar_cuadre_caja'?>" method="post" class="">		
									<td ><input type="submit" id="btn_regresar" name="btn_regresar"class="btn-sm" style="width: 50%;background-color: #C8216A;color: #FFFFFF;" value="Regresar"/></td>
							</form>
						</tr>
					</table>
                </div>
